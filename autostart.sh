...
# xrandr --output eDP-1 --mode 1920x1080 --pos 5120x236 --rotate normal --output DP-1 --off --output DP-2 --primary --mode 5120x1440_60.00 --pos 0x0 --rotate normal --output DP-3 --off
