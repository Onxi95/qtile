...
xrandr --output eDP-1 --primary --mode 1920x1080 --pos 0x0 --rotate normal --output DP-1 --off --output DP-2 --mode 5120x1440_55.00 --pos 1920x0 --rotate normal --output DP-3 --off
